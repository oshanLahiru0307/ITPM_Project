...
import Donation from '../Services/DonationController';

const AdminDonationDonutChart = () => {
  const [items, setItems] = useState([]);
  const [chartData, setChartData] = useState([]);
  const fetchItems = async () => {
    try {
      const response = await Donation.getDonation();
...
export default AdminDonationDonutChart;